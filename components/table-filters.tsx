...
export function TableFilters({
  ...
  if (!isMounted) {
    return (
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center flex-1 w-full">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <Select value={tagFilter} onValueChange={onTagFilterChange}>
              ...
              <SelectContent>
                ...
                <SelectItem value="fasting">Em Jejum</SelectItem>
                <SelectItem value="post_meal">Pós-refeição</SelectItem>
                <SelectItem value="hypo">Hipoglicemia</SelectItem>
                <SelectItem value="hyper">Hiperglicemia</SelectItem>
                <SelectItem value="exercise">Com Exercício</SelectItem>
